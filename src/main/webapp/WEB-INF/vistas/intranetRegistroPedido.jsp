	...
	<div class="container" style="margin-top: 1%">
		...
		<form id="id_form" accept-charset="UTF-8" action="pedido" class="form-horizontal" method="post">
			...
			<div class="panel-group" id="steps">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group col-md-4">
							<div class="col-lg-4">
								<button type="button" id="id_btnCliente" data-toggle='modal' class='btn btn-primary'
									style="width: 170px">BUSCA CLIENTE</button>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group  col-md-4">
							...
							<div class="col-lg-8">
								<input type="date" name="lugarEntrega" id="id_fecha_entrega"
									placeholder="fecha YYYY-MM-DD" required class="form-control" />
							</div>
						</div>
						<div class="form-group col-md-4">
							<label class="col-lg-2 control-label">Lugar Entrega</label>
							<div class="col-lg-8">
								<input type="text" name="fechaEntrega" id="id_lugar_entrega"
									placeholder="Ingrese la direcci�n" required class="form-control" />
							</div>
						</div>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">Selecci�n de Producto</div>
					<div class="panel-body">
						<div class="form-group  col-md-4">
							<div class="col-lg-2">
								<button type="button" id="id_btnProducto" data-toggle='modal' class='btn btn-primary'
									style="width: 170px">BUSCA PRODUCTO</button>
						...
						<div class="form-group  col-md-4">
							...
							<div class="col-lg-8">
								<input type="text" name="nombreProducto" id="id_producto_nombre" class="form-control"
									readonly="readonly" />
							</div>
						</div>
						<div class="form-group  col-md-4">
							...
							<div class="col-lg-8">
								<input type="text" name="precio" id="id_producto_precio" class="form-control"
									readonly="readonly" />
							</div>
						</div>
						<div class="form-group  col-md-4">
							...
							<div class="col-lg-8">
								<input type="text" name="stock" id="id_producto_stock" class="form-control"
									readonly="readonly" />
							</div>
						</div>
						<div class="form-group  col-md-4">
							...
							<div class="col-lg-8">
								<input type="text" name="cantidad" id="id_producto_cantidad" class="form-control"
				...
				<div class="panel-body">
					<div class="form-group">
						<div class="col-lg-9 col-lg-offset-3">
							<button type="button" id="id_btnAgregar" class="btn btn-primary" style="width: 170px">AGREGA
								PRODUCTO</button>
							<button type="button" id="id_btnRegistrar" class="btn btn-primary"
								style="width: 170px">REGISTRA PEDIDO</button>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-12">
							<table id="id_table_boleta" class="table table-striped table-bordered">
								<thead>
									<tr>
										<th style="text-align:center; width: 5%">C�digo</th>
							...
							<div class="panel-group" id="steps">
								<div class="panel panel-default">
									<div class="form-group">
										...
										<div class="col-lg-5">
											<input id="id_txtProducto" class="form-control" name="producto"
												type="text" />
										</div>
									</div>
									<div class="form-group">
		...
		$("#id_btnRegistrar").click(function () {
			...
			if (var_cli == "-1") {
				...
				$.ajax({
					...
					type: 'POST',
					dataType: 'json',
					//Vienen de los par�metros del controlador, revisar los nombres
