...
<div class="container" style="margin-top: 1%">
		 ...
		 <div class="col-md-23" >  
					...
					<div class="row" style="height: 70px">
						<div class="col-md-3" >
								<input class="form-control" id="id_txt_filtro"  name="filtro" placeholder="Ingrese la Raz�n Social" type="text" maxlength="30"/>
						</div>
						<div class="col-md-2" >
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                ...
		                                <div class="panel-body">
		                                	...
		                                	<div class="form-group">
			                                       <label class="col-lg-3 control-label" for="id_reg_razonsocial" style="text-align: right;">RAZ�N SOCIAL</label> <!-- El registro no lleva ID -->
			                                        <div class="col-lg-6">
														<input class="form-control" id="id_reg_razonsocial" name="razonsocial" placeholder="Ingrese la Raz�n Social" type="text" maxlength="25"/>
			                                        </div>
			                                   </div>     
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_direccion" style="text-align: right;">DIRECCI�N</label>
		                                        <div class="col-lg-6">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_telefono" style="text-align: right;">TEL�FONO</label>
		                                        <div class="col-lg-4">
		                        ...
		                        <div class="panel panel-default">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                   ...
		                                   <div class="form-group">
			                                       <label class="col-lg-3 control-label" for="id_act_razonsocial" style="text-align: right;">RAZ�N SOCIAL</label>
			                                        <div class="col-lg-6">
														<input class="form-control" id="id_act_razonsocial" name="razonsocial" placeholder="Ingrese la Raz�n Social" type="text" maxlength="25"/>
			                                        </div>
			                                   </div>     
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_direccion" style="text-align: right;">DIRECCI�N</label>
		                                        <div class="col-lg-6">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_telefono" style="text-align: right;">TEL�FONO</label>
		                                        <div class="col-lg-4">
