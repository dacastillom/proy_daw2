...
<body>
	...
	<div class="container" style="margin-top: 1%">
		...
		<div class="col-md-23">
			...
			<div class="row" style="height: 70px">
				<div class="col-md-3">
					<input class="form-control" id="id_txt_filtro" name="filtro" placeholder="Ingrese la Raz�n Social"
						...
						<table id="id_table" class="table table-striped table-bordered">
							<thead>
								<tr>
									...
									<th style="text-align:center; width: 18%">Raz�n Social</th>
									<th style="text-align:center; width: 12%">RUC</th>
									<th style="text-align:center; width: 15%">Direcci�n</th>
									<th style="text-align:center; width: 10%">Tel�fono</th>
									...
									<div id="stepOne" class="panel-collapse collapse in">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_razonsocial"
													style="text-align: right;">RAZ�N SOCIAL</label>
												<!-- El registro no lleva ID -->
												<div class="col-lg-6">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_ruc"
													style="text-align: right;">RUC</label>
												<div class="col-lg-4">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_direccion"
													style="text-align: right;">DIRECCI�N</label>
												<div class="col-lg-6">
													<input class="form-control" id="id_reg_direccion" name="direccion"
														placeholder="Ingrese el correo" type="text" maxlength="25" />
												</div>
											</div>

											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_telefono"
													style="text-align: right;">TEL�FONO</label>
												<div class="col-lg-4">
													<input class="form-control" id="id_reg_telefono" name="telefono"
														placeholder="Ingrese el tel�fono" type="text" maxlength="9" />
												</div>
											</div>

											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_celular"
													style="text-align: right;">CELULAR</label>
												<div class="col-lg-4">
													<input class="form-control" id="id_reg_celular" name="celular"
														placeholder="Ingrese el celular" type="text" maxlength="9" />
												</div>
											</div>

											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_contacto"
													style="text-align: right;">CONTACTO</label>
												<div class="col-lg-4">
													<input class="form-control" id="id_reg_contacto" name="contacto"
														placeholder="Ingrese el contacto" type="text" maxlength="25" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<label class="col-lg-3 control-label" for="id_reg_departamento"
													style="text-align: right;">DEPARTAMENTO</label>
												<div class="col-lg-5">
													<select id="id_reg_departamento" class='form-control'>
														<!-- name="departamento" -->
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_provincia"
													style="text-align: right;">PROVINCIA</label>
												<div class="col-lg-5">
													<select id="id_reg_provincia" class='form-control'>
														<!-- name="provincia" -->
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_distrito"
													style="text-align: right;">DISTRITO</label>
												<div class="col-lg-5">
													<select id="id_reg_distrito" name="ubigeo.idUbigeo"
														class='form-control'>
								...
								<div class="panel panel-default">
									...
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_ID"
													style="text-align: right;">ID</label>
												<div class="col-lg-2">
													<input class="form-control" id="id_ID" readonly="readonly"
														name="idProveedor" type="text" maxlength="4" />
												</div>
											</div>

											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_razonsocial"
													style="text-align: right;">RAZ�N SOCIAL</label>
												<div class="col-lg-6">
													<input class="form-control" id="id_act_razonsocial"
														name="razonsocial" placeholder="Ingrese la Raz�n Social"
														type="text" maxlength="25" readonly="readonly" />
												</div>
											</div>

											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_ruc"
													style="text-align: right;">RUC</label>
												<div class="col-lg-4">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_direccion"
													style="text-align: right;">DIRECCI�N</label>
												<div class="col-lg-6">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_telefono"
													style="text-align: right;">TELEFONO</label>
												<div class="col-lg-4">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_celular"
													style="text-align: right;">CELULAR</label>
												<div class="col-lg-4">
													<input class="form-control" id="id_act_celular" name="celular"
														placeholder="Ingrese el celular" type="text" maxlength="9" />
												</div>
											</div>

											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_contacto"
													style="text-align: right;">CONTACTO</label>
												<div class="col-lg-4">
													<input class="form-control" id="id_act_contacto" name="contacto"
														placeholder="Ingrese el contacto" type="text" maxlength="25" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<label class="col-lg-3 control-label" for="id_act_departamento"
													style="text-align: right;">DEPARTAMENTO</label>
												<div class="col-lg-5">
													<select id="id_act_departamento" class='form-control'>
														<!--name="departamento" -->
														<option value=" ">[Seleccione Departamento]</option>
													</select>
												</div>
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_provincia"
													style="text-align: right;">PROVINCIA</label>
												<div class="col-lg-5">
													<select id="id_act_provincia" class='form-control'>
														<!--name="provincia"   -->
														<option value=" ">[Seleccione Provincia]</option>
													</select>
												</div>
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_distrito"
													style="text-align: right;">DISTRITO</label>
												<div class="col-lg-5">
													<select id="id_act_distrito" name="ubigeo.idUbigeo"
														class='form-control'>
														<option value=" ">[Seleccione Distrito]</option>
													</select>
												</div>
	...
	<script type="text/javascript">
		...
		$('#id_reg_departamento').change(function () { //Funci�n an�nima
	...
	<script type="text/javascript">
		...
		//Para la Actualizaci�n- Departamento
		...
		//Para la Actualizaci�n- Provincia
		...
		//Para la Actualizaci�n- Distrito
		...
		$('#id_form_registra').bootstrapValidator({
			...
			fields: {
				"razonsocial": {
					...
					validators: {
						notEmpty: {
							message: 'La Raz�n Social es obligatoria'
						},
						stringLength: {
							min: 3,
							max: 40,
							message: 'El Raz�n Social es de 3 a 40 caracteres'
						},
					}
				},
				"ruc": {
				...
				"direccion": {
					...
					validators: {
						...
						stringLength: {
							min: 3,
							max: 40,
							message: 'La direcci�n debe ser de 3 a 40 caracteres'
						}
					}
				},
				"telefono": {
