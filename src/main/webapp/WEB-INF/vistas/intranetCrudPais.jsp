...
<div class="container" style="margin-top: 5%"><h4>Crud País</h4></div>
...
<div class="col-md-23" >  
			...
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8" action="registraActualizaCrudPais" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepOne">Datos de la Pais</a></h4>
		                            </div>
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                     ...
		                                     <div class="form-group">
  											...
  											<div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_iso">Iso</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_iso" name="iso" placeholder="Ingrese el Iso" type="text" maxlength="20"/>
		                                        </div>
		                                    </div>   
			...
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action="registraActualizaCrudPais" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_idPais" readonly="readonly" name="idPais" type="text" maxlength="8"/>
		                                        </div>
		                                     </div>
		                                     <div class="form-group">
		  ...
		  <div class="modal fade" id="idModalElimina" >
					...
					<div class="modal-content">
						<div class="modal-header" style="padding: 35px 50px">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h4><span class="glyphicon glyphicon-ok-sign"></span> Eliminar Pais</h4>
						</div>
...
$("#id_btn_filtrar").click(function(){
	...
	$.getJSON("consultaCrudPais",{"filtro":fil}, function (lista){
		agregarGrilla(lista);
	});
});
	 ...
	 $('#id_table').DataTable({
			...
			columns:[
				...
				{data: function(row, type, val, meta){
					var salida='<button type="button" style="width: 90px" class="btn btn-info btn-sm" onclick="editar(\''+row.idPais + '\',\'' + row.iso +'\',\'' + row.nombre +  '\')">Editar</button>';
					return salida;
				},className:'text-center'},	
				{data: function(row, type, val, meta){
				    var salida='<button type="button" style="width: 90px" class="btn btn-warning btn-sm" onclick="eliminar(\'' + row.idPais + '\')">Eliminar</button>';
					return salida;
				},className:'text-center'},													
			]                                     
	    });
...
function editar(nombre,iso,idPais){	
	$('#id_act_pais').val(idPais);
	$('#id_act_nombre').val(nombre);
	$('#id_act_estado').val(iso);
