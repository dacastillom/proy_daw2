		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-3">
													<input class="form-control" id="id_reg_serie" name="serie" placeholder="Ingrese el n�mero de serie" type="text" maxlength="2"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-3">
													<input class="form-control" id="id_act_serie" name="serie" placeholder="Ingrese el n�mero de serie" type="text" maxlength="45"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
